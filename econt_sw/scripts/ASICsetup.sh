...
python testing/i2c.py --yaml configs/startup.yaml --write --quiet --i2c ASIC,emulator
...
python testing/i2c.py --name PLL_phase_of_enable_1G28,MISC_run --value ${GOODPHASEPLL},1 --i2c ASIC,emulator --quiet
...
echo "FC locked / PUSM state"
python3 testing/i2c.py --name FCTRL_locked,PUSM_state
#echo "PUSM state"
