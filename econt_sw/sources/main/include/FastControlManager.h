...
class FastControlManager
{
 public:
  ...
  void enable_periodic_l1a_C(int val);
  void enable_periodic_l1a_D(int val);
  ...
  void set_l1a_C_bx(int val);
  void set_l1a_C_prescale(int val);
  void set_l1a_D_bx(int val);
  void set_l1a_D_prescale(int val);
