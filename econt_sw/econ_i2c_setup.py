...
if translate:
    ...
    # Write and Read
    for addr,vals in pairs.items():
        val = vals[0].to_bytes(vals[1], 'little')
        print(hex(addr), hex(vals[0]), vals[1], vals[0].to_bytes(vals[1], 'little'))
        i2c.write(0x20, addr, val)
        readback = i2c.read(0x20, addr, vals[1])
        print("Current value: ",hex(addr), "0x%02x"%tuple(readback))
    ...
    print("Current value: ",hex(0x03a9 + 0x7), "0x%02x"%tuple(readback))
    ...
    print("Current value: ",hex(0x03a9 + 0x2), "0x%02x"%tuple(readback))
    ...
    print("Current value: ",hex(0x0380 + 0x12), "0x%02x"%tuple(readback))
    ...
    print("Current value: ",hex(0x0380 + 0x14), "0x%02x"%tuple(readback))
    ...
    print("Current value: ",hex(0x0380 + 0x16), "0x%02x"%tuple(readback))
    ...
    print("Current value: ",hex(0x380 + 0x9), "0x%02x"%tuple(readback))
    ...
    print("Current value: ",hex(0x0380), "0x%02x"%tuple(readback))
    ...
    for i in range(12):
        ...
        print("Current value: ",hex(0x0000 + 0x00 + 0x40*i), "0x%02x"%tuple(readback))
